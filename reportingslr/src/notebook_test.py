...
if __name__ == "__main__":
    studies=load_report_csv("../data/report.0.0.99.csv",ID_PAPER, enc='cp1252')
    MAP_FILE='../data/countries.geojson'
    CITATION_FILE='../data/citations_per_paper.xlsx'
    REPORT_FILE="../data/report.0.0.99.xlsx"
...
#     df = create_dataframe_languages_by_paradigm(languages, lambda s:language_kind(s)=='Implementation')
#     print(df)
# 
# 
...
#    generate_venues_ordered_by_num_studies(studies) 
    ...
    df_rp= create_dataframe_from_excel(REPORT_FILE,'report.0.0.99', ID_PAPER)
    ...
    df_focus= create_dataframe_from_excel(REPORT_FILE,'Focus', ID_PAPER)
...
#     df=create_dataframe_count_languages_by_focus(df_focus)
#     print(df)
